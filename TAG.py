...
def sword_run():
        if weapon=="1":
            ...
            if sword_attack == "1":
                ...
                time.sleep(1)   
                print("You stand over the figure who doesn't look as big anymore\n")
                time.sleep(1.5)
                print("\"where is the Princess?\", You demand\n")
                time.sleep(1.5)
                print("\"You're good with a sword, are you as good with your brain? Answer these riddles and you'll find the Princess\"\n") 
...
def riddles():
    ...
    time.sleep(1.5)
    print("One night, a Queen, a King, a Princess and a Prince were on a boat.\n")
    time.sleep(1)
    print("The queen, King, Prince and princess fell off the boat. Who was left?\n")
    time.sleep(1)
    riddle_one= input("Who was left? ")
    if riddle_one.lower() == "the knight" or riddle_one.lower()=="knight" or riddle_one.lower()=="one knight":
